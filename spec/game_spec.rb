...
describe 'Game' do
  ...
  context 'gameplay methods' do
    ...
    describe '#get_next_move' do
      ...
      it 'calls #make_move when current_player is an AIPlayer' do
        @game.board.all_cells = { "1A"=>'X', "2A"=>nil, "3A"=>nil,
                                  "1B"=>nil, "2B"=>nil, "3B"=>nil,
                                  "1C"=>nil, "2C"=>nil, "3C"=>nil }
        @game.player_two.ai = MockAI
        @game.get_next_move
        @game.board.all_cells.should == { "1A"=>'X', "2A"=>'O', "3A"=>nil,
                                          "1B"=>nil, "2B"=>nil, "3B"=>nil,
                                          "1C"=>nil, "2C"=>nil, "3C"=>nil }
      end
    end
